...
let arr2 = [];
let tp;
for (let i = 0; i < newarr.length1; i++) {
...
//------------------------------------------------------------------------//
module.exports = { greater, less, prmArray, evenarray, odarray, numsquare, root, palindrome, reverse, reversestr, sort, prime, circle, rect, square }
